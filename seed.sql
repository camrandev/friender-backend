...
VALUES
    ('user1@example.com', 'password1', 'John', 'Doe', '02215',FLOOR(RANDOM() * 5 + 1), 'profile_image.jpg', 'Hobbies', 'Interests'),
    ('user2@example.com', 'password2', 'Jane', 'Smith', '02130',FLOOR(RANDOM() * 5 + 1), 'profile_image.jpg', 'Hobbies', 'Interests'),
    ('user3@example.com', 'password3', 'Mark', 'Johnson', '02119',FLOOR(RANDOM() * 5 + 1), 'profile_image.jpg', 'Hobbies', 'Interests'),
    ('user4@example.com', 'password4', 'Sarah', 'Williams', '02199',FLOOR(RANDOM() * 5 + 1), 'profile_image.jpg', 'Hobbies', 'Interests'),
    ('user5@example.com', 'password5', 'David', 'Brown', '02114',FLOOR(RANDOM() * 5 + 1), 'profile_image.jpg', 'Hobbies', 'Interests'),
    ('user6@example.com', 'password6', 'Amy', 'Taylor', '02135',FLOOR(RANDOM() * 5 + 1), 'profile_image.jpg', 'Hobbies', 'Interests');
