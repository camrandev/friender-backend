...
VALUES
    ('user1@example.com', '$2b$12$scZRkQwNy4L9V1MXR1cEEedNujPuUqJCKnm1WlEK8CtWDkZ1.4ZPq', 'John', 'Doe', '02215',FLOOR(RANDOM() * 5 + 1), '', 'Hobbies', 'Interests'),
    ('user2@example.com', '$2b$12$scZRkQwNy4L9V1MXR1cEEedNujPuUqJCKnm1WlEK8CtWDkZ1.4ZPq', 'Jane', 'Smith', '02130',FLOOR(RANDOM() * 5 + 1), '', 'Hobbies', 'Interests'),
    ('user3@example.com', '$2b$12$scZRkQwNy4L9V1MXR1cEEedNujPuUqJCKnm1WlEK8CtWDkZ1.4ZPq', 'Mark', 'Johnson', '02119',FLOOR(RANDOM() * 5 + 1), '', 'Hobbies', 'Interests'),
    ('user4@example.com', '$2b$12$scZRkQwNy4L9V1MXR1cEEedNujPuUqJCKnm1WlEK8CtWDkZ1.4ZPq', 'Sarah', 'Williams', '02199',FLOOR(RANDOM() * 5 + 1), '', 'Hobbies', 'Interests'),
    ('user5@example.com', '$2b$12$scZRkQwNy4L9V1MXR1cEEedNujPuUqJCKnm1WlEK8CtWDkZ1.4ZPq', 'David', 'Brown', '02114',FLOOR(RANDOM() * 5 + 1), '', 'Hobbies', 'Interests'),
    ('user6@example.com', '$2b$12$scZRkQwNy4L9V1MXR1cEEedNujPuUqJCKnm1WlEK8CtWDkZ1.4ZPq', 'Amy', 'Taylor', '02135',FLOOR(RANDOM() * 5 + 1), '', 'Hobbies', 'Interests');
